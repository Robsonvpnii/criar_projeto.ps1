...
class _LicenseScreenState extends State<LicenseScreen> {
  ...
  Future<void> _activateLicense() async {
    ...
    if (license.isEmpty) {
      setState(() {
        _message = 'Por favor, insira uma licenca valida';
    ...
    try {
      ...
      if (response.statusCode == 200) {
        ...
        if (data['status'] == 'success' || data['valid'] == true) {
          ...
          setState(() {
            _message = 'Licenca ativada com sucesso!';
          ...
          setState(() {
            _message = 'Licenca invalida. Tente novamente.';
            _messageColor = Colors.red;
          });
        }
      } else {
      ...
      setState(() {
        _message = 'Erro de conexao. Verifique sua internet.';
        _messageColor = Colors.red;
      });
    } finally {
      setState(() => _isLoading = false);
  ...
  Future<void> _saveConfigFile() async {
    try {
      ...
      setState(() {
        _message = 'Erro ao salvar arquivo de configuracao';
        _messageColor = Colors.red;
      });
    }
  }
    ...
    try {
      ...
      if (mounted) {
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(
            content: Text('Erro ao excluir arquivo de configuracao'),
